...
const deleteTodoById = async (id) => await todosModel.findByIdAndDelete(id)



module.exports = { getAllTodos, saveTodo, getTodoById, updateTitleTodoById, deleteAllTodos, getUserTodos,deleteTodoById }